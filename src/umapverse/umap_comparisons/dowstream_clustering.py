...
df_eps_tuning.to_csv("src/umapverse/umap_comparisons/images/dbscan_eps_tuning.csv", index=False)
...
csv_filename = f"src/umapverse/umap_comparisons/images/downstream_clustering_results_{n_points}.csv"
df_results.to_csv(csv_filename, index=False)
print(f"Results saved to: {csv_filename}")

txt_filename = f"src/umapverse/umap_comparisons/images/downstream_clustering_results_{n_points}.txt"
